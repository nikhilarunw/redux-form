...
describe('readField', function () {
  ...
  it('should change complex field instances when updating a mixed field', function () {
    var fields = {};
    readField({
      pig: {
        foo: [{
    ...
    var beforeArrayField = fields.pig.foo;
    var beforeObjectField = fields.pig.foo[0];
    ...
    var afterArrayField = fields.pig.foo;
    var afterObjectField = fields.pig.foo[0];
  ...
  it('should not provide mutators when readonly', function () {
    var fields = {};
    readField({}, 'foo', undefined, fields, {}, undefined, false, _extends({}, defaultProps, {
      readonly: true
    }));
